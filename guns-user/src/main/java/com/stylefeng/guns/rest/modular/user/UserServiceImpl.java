...
public class UserServiceImpl implements UserAPI {
    ...
    public UserInfoModel getUserInfo(int id) {
        //根据用户查询用户信息[MoocUserT]
        MoocUserT moocUserT = moocUserTMapper.selectById(id);
    ...
    public UserInfoModel updateUserInfo(UserInfoModel userInfoModel) {
        ...
        moocUserT.setBeginTime(/*time2Date(userInfoModel.getBeginTime())*/null);
        moocUserT.setHeadUrl(userInfoModel.getHeadAddress());
        moocUserT.setEmail(userInfoModel.getEmail());
        moocUserT.setAddress(userInfoModel.getAddress());
        moocUserT.setUserPhone(userInfoModel.getPhone());
        moocUserT.setUserSex(userInfoModel.getSex());
        moocUserT.setUpdateTime(/*time2Date(System.currentTimeMillis())*/null);
